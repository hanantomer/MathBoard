...
export interface AnswerLineCreationAttributes extends Optional<AnswerLineAttributes, "id"> {
}
...
export interface AnswerRectCreationAttributes extends Optional<AnswerRectAttributes, "id"> {
}
...
export interface QuestionCreateAttributes extends Optional<QuestionAttributes, "id"> {
}
export interface QuestionLineAttributes extends BaseNotation, LineAttributes, QuestionNotationAttributes {
}
export interface QuestionLineCreationAttributes extends Optional<QuestionLineAttributes, "id"> {
}
export interface QuestionPointAttributes extends BaseNotation, PointAttributes, QuestionNotationAttributes {
}
export interface QuestionPointCreationAttributes extends Optional<QuestionPointAttributes, "id"> {
}
export interface QuestionRectAttributes extends BaseNotation, RectAttributes, QuestionNotationAttributes {
}
export interface QuestionRectCreationAttributes extends Optional<QuestionRectAttributes, "id"> {
}
...
export interface LessonLineCreationAttributes extends Optional<LessonLineAttributes, "id"> {
}
export interface LessonPointAttributes extends BaseNotation, PointAttributes, LessonNotationAttributes {
}
export interface LessonPointCreationAttributes extends Optional<LessonPointAttributes, "id"> {
}
export interface LessonRectAttributes extends BaseNotation, RectAttributes, LessonNotationAttributes {
}
export interface LessonRectCreateAttributes extends Optional<LessonRectAttributes, "id"> {
}
...
export interface StudentLessonCreateAttributes extends Optional<StudentLessonAttributes, "id"> {
}
